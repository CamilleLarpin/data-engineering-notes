...
## [python] · Rule · `load_dotenv()` does not override existing env vars — direnv takes precedence
> 2026-03-06 · source: data-engineering-notes
...
## [python] · Rule · direnv env vars not available in make subshells if `.env` parse fails
> 2026-03-06 · source: data-engineering-notes
...
## [telegram-bot] · Rule · Always register an error handler — unhandled exceptions crash silently
> 2026-03-06 · source: data-engineering-notes
...
## [anthropic-sdk] · Note · API usage limit returns BadRequestError 400, not a rate limit 429
> 2026-03-06 · source: data-engineering-notes
